...
|---|---|---|
| 🤖 [Bot GTA RP](https://github.com/rjohny-dev) | Bot de gerenciamento para servidor de roleplay com rastreamento de ações por cargo e menus interativos | `Node.js` `Discord.js` |
| 🚧 Em breve | Novo projeto com IA integrada | `React` `Node.js` `IA` |
...
![Status](https://img.shields.io/badge/disponível_para_freelas-1D9E75?style=flat-square)
